...
class OllamaRF(object):
    ...
    def respond(self, user_response,
      ...
      objective_to_situation  =  { "engagement" :   "You want to encourage the conversation forward." ,   
                                      "confrontational" :  "You want to correct someone." ,  
                                      "defend" :         "You will defend your ideas" ,  
                                      ...
                                      "explore" :     "You ant to learn new things", 
                                      "altruism"  :   "You want to know about the user.",
