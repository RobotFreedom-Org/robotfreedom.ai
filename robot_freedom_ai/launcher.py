...
class Launcher(object):
    ...
    def set_cmds(self  ):
        ...
        self.commands["sense.balance"]           = {"cmd" : ["python3", "daemon.py", "-m senses.balance","-c Balance" ,"-r " + self.robot ], "subp":-1}
    ...
    def server_forever(self ):
        ...
        print("Components          :"    +  " ".join(["speech","device_control","communication","mic", "camera"])  ) 
