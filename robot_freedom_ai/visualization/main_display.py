...
SENSES["pressure"]    = {"color":pink}  #Barometric pressure
SENSES["vox"]         = {"color":yellow}  

#Maybe via a dedicade ardiuno and pi
SENSES["identification"]              = {"color":pink}  #photo of cinder Need nano
SENSES["collision_avoidance_front"]   = {"color":pink}  
SENSES["collision_avoidance_back"]    = {"color":pink}  
SENSES["collision_avoidance_left"]    = {"color":pink}  
SENSES["collision_avoidance_right"]   = {"color":pink}  
...
class MainDisplay():
    ...
    def __init__(self, robot, nerves, config, settings):
        ...
        self.touch_img = pygame.image.load('./assets/cinder.jpg') 
